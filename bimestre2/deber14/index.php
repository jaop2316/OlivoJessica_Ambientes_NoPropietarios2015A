...
<table id="tabla_usuarios" class="table">
  ...
  foreach ($usuarios as $usuario) {
    ...
    echo '<tr>';
     echo '<td class="id" data-campo="id">'. $usuario['id'] .'</td>';
    echo '<td id="nombre' . $contador . '" data-campo="nombre">'. $usuario['nombre'] .'</td>';
    echo '<td id="email' . $contador . '" data-campo="email">'. $usuario['email'] .'</td>';
    echo '<td id="direccion' . $contador . '" data-campo="direccion"> '. $usuario['direccion'] .' </td>';
     echo '<td id="telefono' . $contador . '" data-campo="telefono"> '. $usuario['telefono'] .' </td>';
    echo '<td id="usuario' . $contador . '" data-campo="usuario"> '. $usuario['usuario'] .' </td>';
